...
# Test Cases
assert basketballHOF(4, 4000, 2500)
assert basketballHOF(3, 7000, 3000)
assert basketballHOF(10, 20000, 10000)
...
## Problem 10 ##
# Write a function that sums all of the EVEN numbers from 1 to some given
# number 'num'.
